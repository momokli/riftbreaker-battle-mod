...
| # | Frage | Befund | Beleg |
|---|---|---|---|
| (a) | Empfängt der Mod Wellen-/Send-Trigger? | Ja — über den Konsolen-Pfad: `exec_cmd_client "rb_wave 3"` → `ConsoleService:ExecuteCommand` → Lua-Command `rb_wave` → `[RBBATTLE] event=wave level=3 status=start/done` (Prod-Log 2026-09-09, 8 Spawns; Issue #18). Das sind **Mod-eigene** Events beim Send-Spawn — kein Engine-"Wave-Event". | Issue #18, client-mod/README v0.2.0 |
