...
- **Repo-Stand rbbattle v0.32.0**: Der Design-Kern ist implementiert — Abgleich unten im Abschnitt „Umsetzungsstand“; dort sind alle offenen Abweichungen explizit als `offen` markiert.
...
## Umsetzungsstand (Repo, rbbattle v0.32.0)
