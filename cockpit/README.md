...
|---|---|
| `get_state` | Ressourcen (`carbonium`/`ironium` + Max), `mission_flow`, `mission_flow_active`, `mission_flow_payload.spawn_point`, `creatures_base_difficulty`, `hq_hp`/`hq_hp_max`/`hq_dead` (nativ C++, #573/#511) |
