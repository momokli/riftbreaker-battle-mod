...
1. Mod lädt, Version 0.27.2, HQ initialisiert (`hq_hp=100 hq_dead=false`).
...
1. Mod lädt, Version 0.27.2; `rb_buy_wave`/`rb_shop`/`rb_queue` registriert,
...
1. Mod lädt, Version 0.27.2; `rb_hud_ui`/`rb_quick` registriert,
...
1. Mod lädt, Version 0.27.2 (kein Version-Bump); `rb_balance` registriert.
