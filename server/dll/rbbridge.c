...
/*   = 0x76aad119 => dom_mananger). Der DOM-Node ist damit             */
/*   deterministisch auffindbar: vftable-Scan + TypeHash == fnv1a(DOM).*/
/*                                                                    */
...
/* unberuehrt. Diese Bridge bildet exakt SetSuspended ab (#520);       */
/* PlanetaryJump ist Folge-Issue (#553).                               */
/*                                                                    */
/* Steht AUSSERHALB des #ifndef-RBBRIDGE_HOSTTEST-Blocks, damit der    */
...
/* Lua-Skriptpfad der DOM-Klasse; die TypeHash-Konstante ist NUR
 * Verifikations-Notiz — der Resolver hasht den Pfad zur Laufzeit. */
static const char RBBRIDGE_DOM_SCRIPT[] = "lua/missions/v2/dom_manager.lua";
#define RBBRIDGE_DOM_SCRIPT_HASH 0x76aad119u

/* FNV-1a-32 (Offset-Basis 0x811c9dc5, Primzahl 0x01000193) — identisch zur
 * Resource-StringHash-Implementierung (docs/research/resource-hash-map.md).
...
/* Byte-Signatur von LuaGraphNode::SetSuspended (die GANZE Funktion, 7 Bytes,
 * Build 2.0.58485): `mov byte ptr [rcx+0xF1], dl; ret`. Kein rel32-Operand
 * => keine Wildcard-Maske noetig. Im .text genau EINMAL vorhanden; zur
...
static int set_suspended_sig_selfcheck(void)
{
     ...
     * +0xF1? Vollbreite Pruefung, damit die Layout-Konstante wirklich an
     * die Signatur gebunden ist. */
    {
