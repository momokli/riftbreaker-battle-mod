...
Reads cockpit/cockpit.html (#474) and emits the C
...
pipe_bridge.c and stays in server/pipe-bridge/.
...
BRIDGE_DIR = os.path.join(ROOT, "server", "pipe-bridge")
SRC = os.path.join(ROOT, "cockpit", "cockpit.html")
